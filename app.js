...
========================================================= */
const TRANSLATION_STANDARD = {
  6:{
    source:'和合本',
    reference:'约翰福音 1:1',
    text:'太初有道，道与神同在，道就是神。',
    note:'本课只聚焦 ὁ λόγος 的主格与 τὸν θεόν 的受格；中文采用和合本。',
    li:null
  },
  7:{
    source:'和合本（教材对应短语）',
    reference:'教材例句：ὁ λόγος τοῦ θεοῦ',
    text:'神的道',
    note:'教材明确把所有格的关键词处理为“的”；完整例句中的 σώσει 不属于本课范围。',
    li:null
  },
  8:{
    source:'教材训练译文',
  ...
  10:{
    source:'教材词义',
    reference:'约翰福音 1:14 中的 σάρξ',
    text:'肉身。',
    note:'本课只训练第三格变式词形识别，不展开整句。',
    li:null
  },
  12:{
    source:'和合本',
    reference:'马可福音 12:36',
    text:'大卫自己藉着圣灵说。',
    note:'本课焦点是 αὐτός 的强调用法。',
    li:null
  },
  13:{
    source:'和合本',
    reference:'路加福音 1:32',
    text:'他要为大，称为至高者的儿子。',
    note:'本课只聚焦 οὗτος 的指示/代词用法；不展开未学习的未来式。',
    li:null
  },
  14:{
    source:'教材训练译文',
    reference:'教材关系代词例句',
    text:'我们认识的那个人。',
    note:'本课只聚焦先行词与关系代词的关系；完整动词分析延后。',
    li:null
  },
  16:{
    source:'教材训练译文',
    reference:'教材例句：ἐγὼ ἀγαπῶ Ῥόβιν',
    text:'我爱罗宾。',
    note:'这是教材教学例句，不是圣经经文。',
    li:null
  },
  18:{
    source:'教材训练译文',
    reference:'教材例句：ἔρχεται',
    text:'他／她／它正在来。',
    note:'保持教材当前阶段的“关身／被动形主动意”处理。',
    li:null
  },
  19:{
    source:'教材训练译文',
    reference:'教材例词：πορεύσομαι',
    text:'我将去。',
    note:'教材阶段按关身形主动意处理。',
    li:null
  },
  21:{
    source:'和合本',
    reference:'启示录 5:9',
    text:'暂不固定：准确目标词形与课本说明需进一步核对。',
    note:'基础版不把未经核对的形态与译文写死。',
    li:null
  },
  22:{
    source:'教材训练译文',
    reference:'教材词形：ἔλαβον',
    text:'我拿了。',
    note:'先训练第二不定过去式的词形与词典形对应。',
    li:null
  },
  23:{
    source:'和合本（教材例句）',
    reference:'使徒行传 2:38',
    text:'你们各人要悔改。',
    note:'μετανοήσατε 为第一不定过去式，但本句是命令语气；本课只作形态观察，不把命令语气当主训练。',
    li:null
  },
  24:{
    source:'和合本',
    reference:'罗马书 6:3',
    text:'岂不知我们这受洗归入基督耶稣的人，是受洗归入他的死么？',
    note:'本课焦点是 ἐβαπτίσθημεν 的不定过去式被动直说形式。',
    li:null
  },
  25:{
    source:'和合本',
    ...
    note:'本课焦点是 ἤδη κέκριται；“已经”帮助学生注意完成式的结果持续。',
    li:null
  }
};

const CORPUS_TRAINING = Object.fromEntries(
  Object.entries(TRANSLATION_STANDARD).map(([key,v])=>[
    key,
    {
      translation:v.text,
      translationSource:v.source,
      translationReference:v.reference,
      translationNote:v.note,
      translationAlt:v.li,
      ...({
        6:{task:'先找主词和直接受词，再尝试把整句译成中文。',hint:'先看冠词和词尾：ὁ λόγος 是主格，τὸν θεόν 是受格。',explain:'ὁ λόγος 是主格单数，作主词；τὸν θεόν 是受格单数。这里的字序不能按英文一一对应。',analysis:'ὁ λόγος：主格单数，作主词。ἦν：εἰμί 的未完成式主动直说第三人称单数。πρὸς τὸν θεόν：介词短语，其中 τὸν θεόν 为受格。',mode:'sentence'},
        7:{task:'先找所有格，再把这个短语译成自然中文。',hint:'想到所有格的关键词“的”。',explain:'τοῦ θεοῦ 是 θεός 的所有格单数，修饰 λόγος。',analysis:'ὁ λόγος：中心名词；τοῦ θεοῦ：所有格短语，表示“神的”。本课不展开尚未学习的未来式 σώσει。',mode:'phrase'},
        8:{task:'先把介词和受词看成一个整体，再翻译。',hint:'先找介词 ἐν，再看它后面的词。',explain:'ἐν 与它所带的词组成介词短语，中文自然表达为“在……里”。',analysis:'ἐν：介词；τῇ οἰκίᾳ：定冠词加名词的间接受格形式，整体表达位置关系。',mode:'phrase'},
        9:{task:'先找形容词，再判断它修饰哪个名词。',hint:'注意 ἀγαθός 和 ἄνθρωπος 的性、数、格。',explain:'ἀγαθός 与 ἄνθρωπος 在性、数、格上一致，所以这里是形容词用法。',analysis:'ὁ ἀγαθὸς ἄνθρωπος：ὁ 与 ἄνθρωπος 构成名词短语；ἀγαθός 与其在性、数、格上一致，修饰“人”。',mode:'phrase'},
        10:{task:'先识别 σάρξ 的词性和形式，不急着分析整节。',hint:'今天重点是第三格变式。',explain:'σάρξ 是第三格变式名词；本课重点是辨认词干和词尾。',analysis:'σάρξ：名词，阴性，第三格变式；当前训练只要求先认识其形式，不提前展开 ἐγένετο。',mode:'word'},
        12:{task:'先判断 αὐτός 修饰谁，再翻译。',hint:'它和谁发生一致？',explain:'αὐτὸς 在这里位于名词前，表示强调，意思是“自己”。',analysis:'αὐτὸς：主格阳性单数，与 Δαυίδ 对应，作强调用法，中文自然译为“大卫自己”。',mode:'phrase'},
        13:{task:'先确定指示词指向什么，再翻译。',hint:'不要孤立地把 οὗτος 固定译成一个中文词。',explain:'οὗτος 是指示词，具体中文表达要根据它指向的名词和上下文决定。',analysis:'οὗτος：指示代词/形容词体系中的指示词；在这里重点训练“指向关系”，而不是展开完整句的未来式。',mode:'phrase'},
        14:{task:'先找先行词，再观察关系代名词的功能。',hint:'关系代名词的性、数跟谁？格又由什么决定？',explain:'ὅν 的性、数与先行词一致，但它在关系子句中的功能决定它用直接受格。',analysis:'ὁ ἄνθρωπος 是先行词；ὅν 是关系代名词，性数与先行词一致，格由其在关系子句中的功能决定。本课不展开尚未学习的全部动词形式。',mode:'phrase'},
        16:{task:'先找现在式主动直说的真正人称字尾，再翻译。',hint:'动词本身已经包含“我”。',explain:'ἀγαπῶ 的形式已经包含第一人称单数信息；显出的 ἐγώ 有强调作用。',analysis:'ἀγαπῶ：现在式、主动、直说、第一人称单数。Ῥόβιν 为直接受格。',mode:'sentence'},
        18:{task:'先观察词尾，再判断人称、数和时态。',hint:'注意 -εται。',explain:'ἔρχεται 是现在式第三人称单数的关身/被动形；按照教材目前的学习范围，这里作“关身/被动形主动意”处理。',analysis:'ἔρχεται：现在式、关身/被动形、直说、第三人称单数，来自 ἔρχομαι；本课阶段按教材作主动意义理解。',mode:'word'},
        19:{task:'先找未来式的形式特征，再翻译。',hint:'注意 σ 和人称字尾。',explain:'πορεύσομαι 是未来式关身形；这里按教材所教的关身形主动意理解。',analysis:'πορεύσομαι：未来式关身形、直说、第一人称单数；教材阶段意义按主动“我将去”处理。',mode:'word'},
        21:{task:'今天先练习辨认教材所说的真实经文画面，不固定未经核对的答案。',hint:'教材把启示录5:9作为本课例子；先把词形核准。',explain:'本课重点是未完成式的连续/重复观点，但当前目标词形仍需与底本重新核对。',analysis:'基础版暂不显示未经核准的形态与译文。',mode:'pending'},
        22:{task:'先看往昔号，再判断第二字干。',hint:'ἔλαβον 不是现在式 λαμβάνω 的简单拼接。',explain:'ἔλαβον 使用的是第二不定过去式的第二字干 λαβ-。',analysis:'ἔλαβον：第二不定过去式主动直说第一人称单数，来自 λαμβάνω；本课先掌握形态识别。',mode:'word'},
        23:{task:'先观察 μετανοήσατε 的第一不定过去式词形。',hint:'注意它虽然是第一不定过去式，但这一处属于命令语气。',explain:'μετανοήσατε 是第一不定过去式，但在徒2:38中属于命令语气；本课只借它认识词形。',analysis:'本课主目标是第一不定过去式直说语气，因此这里不把命令语气当成本课主训练。',mode:'pending'},
        24:{task:'先判断主词是否接受动作，再翻译。',hint:'看 θη 这个被动语态时态特征。',explain:'ἐβαπτίσθημεν 是不定过去式被动形式，第一人称复数；主词是动作的接受者。',analysis:'ἐβαπτίσθημεν：不定过去式、被动、直说、第一人称复数。翻译时要保留“我们接受这个行动”的关系。',mode:'sentence'},
        25:{task:'先自己翻译，再判断完成式为什么适合这里的中文表达。',hint:'注意重复号和完成式形式。',explain:'κέκριται 表示一个已经发生的判决，其结果状态仍然持续到现在。',analysis:'ἤδη κέκριται：κέκριται 为现在完成式被动直说第三人称单数；ἤδη 强调“已经”。',mode:'sentence'}
      }[key] || {task:'先读原文，再找出今天学习的重点。',hint:'先做自己的观察。',explain:'需要时再查看第二层解释。',analysis:'需要时再展开完整分析。',mode:'phrase'})
    }
  ])
);
...
function renderCorpusTraining(){
  ...
  if($("showTranslation")){
    $("showTranslation").onclick=function(){
      ...
      if(r){
        r.innerHTML =
          "<div class='translation-source'>" + escapeHtml(training.translationSource || "参考译文") + "</div>" +
          "<div class='translation-main'>" + escapeHtml(training.translation || "暂无固定参考译文") + "</div>" +
          (training.translationReference ? "<div class='translation-reference'>" + escapeHtml(training.translationReference) + "</div>" : "") +
          (training.translationNote ? "<div class='translation-note'>" + escapeHtml(training.translationNote) + "</div>" : "");
